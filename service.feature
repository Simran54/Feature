...
Scenario: View service detail page.
    ...
    Then  I should be able to view Choose Service Category: Education Services (selected by default) 
    And   I should be able to view Search For: Select Any (by default) Dropdown will show Institutions and Courses
    And   I should be able to Search Text Box
